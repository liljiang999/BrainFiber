...
def get_progress():
    try:
        ...
        return jsonify({'progress': '0/13'})  # 默认值
...
#--------------------- 全脑纤维束跟踪生成 （"-select"+ " " + "500000"）指的是生成500000根脑神经纤维束，可在界面上作为参数选择----------------------------#
...
#--------------------- 数据生成-脑神经纤维束特征(TBSS) (可将V1, V2, V3, L1, L2, L3, MD, FA, MO, S0，MD, fa, ad, rd, cl, cp, cs, value, vector)作为可选参数----------------------------#
...
def FiberGeneration( root_subject ):
    steps = [
        SourceDataPreprocess,
        RegFS2DTI,
        ACTPreprocess,
        FODestimate,
        GenTracts_ACTseedGMWMI,
        RegT12MNI152,
        GenTensorInfo,
        GenRegionConnectome,
        GenLobeConnectome,
